<form id="partTimeForm" method="POST" action="{{ url('/submitregistrationform') }}">
    {{csrf_field()}}
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-lg-4">
                @if($programme_types = App\PartTimeProgrammeType::all())
            ...
            <div class="col-lg-4">
                <select type="text" class="form-control" name="programme_mode" required="">
                    <option value="part-time">Programme mode (PART-TIME)</option>
                </select>
            </div>
            <div class="col-lg-4">
