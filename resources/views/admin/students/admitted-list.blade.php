    ...
    <div class="row">
            <div class="">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-fw fa-table"></i> Admitted student list
                    </div>
                    <!-- /.panel-heading -->
                                    ...
                                    <tr class="odd gradeX">
                                        <th>
                                            <form class="unaddmit">
                                                ...
                                                <button type="submit" class="btn btn-danger">UNADMIT</button>
                                                <button id="loading"  class="btn btn-warning" disabled>
                                                    <i class="loader fa fa-plus"></i> UNADDMITING...
                                                </button>
                                                <button id="done" class="btn btn-success" disabled>
                                                    <i class="fa fa-check"></i> UNADMITTED
                                                </button>
                                            </form>
                                        </th>
